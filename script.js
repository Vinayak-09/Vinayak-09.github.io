...
const easterEggWords = ["you look", "beautiful", "great", "fantastic", "thanks"];
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "new":
            ...
            break;
        case "i love you":
            sendTextMessage("Thanks! (uwu) I must be radiating some serious bot charm today.");
            break;
        default:
            if (easterEggWords.some(word => inputText.includes(word))) {
                sendTextMessage("Thanks! I appreciate you saying that!");
            }
            else{
                setTimeout(() => {
